...
import com.wise.ble.scan.bluetoothcompat.ScanRecordCompat;
...
public class ScanResultCompat implements Parcelable {
     ...
     */
    public ScanResultCompat(BluetoothDevice device, ScanRecordCompat scanRecord, int rssi,
                            long timestampNanos) {
        mDevice = device;
    ...
    ScanResultCompat(ScanResult result) {
        mDevice = result.getDevice();//result.getTimestampNanos()
