...
import com.wise.ble.scan.bluetoothcompat.ScanFilterCompat;
import com.wise.ble.scan.bluetoothcompat.ScanSettingsCompat;
 ...
 * <li>当前扫描状态</li>
 * </ol>
 * 注意：回调不在主线程中执行，需要自己在主线程中处理回调（{@link ScanOverListener} and {@link com.hongjia.ble.scan.bluetoothcompat.ScanCallbackCompat}）,
...
public final class BluetoothScanManager {
     ...
     * @param options
     */
    public static void setBleParamsOptions( BleParamsOptions options){
        if (options != null){
