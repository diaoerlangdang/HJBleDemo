package com.wise.wisekit.segment;
...
public class SegmentControl extends View {
    ...
    public interface OnSegmentChangedListener{
        void onSegmentChanged(int oldSelectedIndex, int newSelectedIndex);
    }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(curTouchedIndex != -1){
                    if(mOnSegmentChangedListener != null && mSelectedIndex != curTouchedIndex){
                        mOnSegmentChangedListener.onSegmentChanged(mSelectedIndex, curTouchedIndex);
                    }
    ...
    public void setSelectedIndex(int selectedIndex){
        if(mSelectedIndex != selectedIndex){
            if(mOnSegmentChangedListener != null){
                mOnSegmentChangedListener.onSegmentChanged(mSelectedIndex, selectedIndex);
            }
