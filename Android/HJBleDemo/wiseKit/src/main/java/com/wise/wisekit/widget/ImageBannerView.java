...
/**
 * Created by wuruizhi on 2017/8/13.
 */
...
public class ImageBannerView extends LinearLayout {
     ...
     */
    public void setImageResources(ArrayList<String> urlList, ImageCycleViewListener imageCycleViewListener) {
        // 清除所有子视图
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public ImageCycleAdapter(Context context, ArrayList<String> urlList, ImageCycleViewListener imageCycleViewListener) {
            mContext = context;
            mUrlList = urlList;
