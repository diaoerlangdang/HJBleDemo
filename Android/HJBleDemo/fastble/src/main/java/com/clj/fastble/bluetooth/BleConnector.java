...
public class BleConnector {
    ...
    private void handleCharacteristicNotifyCallback(BleNotifyCallback bleNotifyCallback,
        ...
        if (bleNotifyCallback != null) {
            notifyMsgInit();
            bleNotifyCallback.setKey(BleBluetooth.notificationKey(mCharacteristic));
            bleNotifyCallback.setHandler(mHandler);
            mBleBluetooth.addNotifyCallback(BleBluetooth.notificationKey(mCharacteristic), bleNotifyCallback);
    ...
    private void handleCharacteristicIndicateCallback(BleIndicateCallback bleIndicateCallback,
        ...
        if (bleIndicateCallback != null) {
            indicateMsgInit();
            bleIndicateCallback.setKey(BleBluetooth.notificationKey(mCharacteristic));
            bleIndicateCallback.setHandler(mHandler);
            mBleBluetooth.addIndicateCallback(BleBluetooth.notificationKey(mCharacteristic), bleIndicateCallback);
            mHandler.sendMessageDelayed(
