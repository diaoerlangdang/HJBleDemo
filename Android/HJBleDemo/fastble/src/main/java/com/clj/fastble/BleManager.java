...
public class BleManager {
    ...
    public BluetoothGatt connect(BleDevice bleDevice, BleGattCallback bleGattCallback) {
        ...
        if (bleDevice == null || bleDevice.getDevice() == null) {
            ...
            if (bleBluetooth == null) {
                bleGattCallback.onConnectFail(bleDevice, new OtherException("Connection already active or connection limit reached"));
                return null;
            }
    ...
    public boolean stopNotify(BleDevice bleDevice,
        ...
        if (success) {
            bleBluetooth.removeNotifyCallback(uuid_service + "|" + uuid_notify);
        }
        return success;
    }
    ...
    public boolean stopIndicate(BleDevice bleDevice,
        ...
        if (success) {
            bleBluetooth.removeIndicateCallback(uuid_service + "|" + uuid_indicate);
        }
        return success;
    }
